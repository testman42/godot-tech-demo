# deprecated script, functions should be removed to relevant actors
...
# We can potentially end up with a lot of groups that are just shortcuts

onready var navigation = get_tree().get_nodes_in_group("rts_navigation")[0]
